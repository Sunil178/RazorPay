...
<head>
    <title>Fight against COVID – 19  | ACT NOW by Benefactory</title>
    <meta name="viewport" content="width=device-width">
    <!-- <meta name="csrf-token" content="{{ csrf_token() }}"> -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>

    <link rel="stylesheet" type="text/css" href="/assets/css/benefactory_coronavirus.css">
...
<div class="wrapper">
        <div class="section1">
            <div class="beneheader">
                <div class="benelogo">
                    <a href="http://benefactory.live/">
                        <img src="assets/Benefactory_White.png" height="80">
                    </a>
                </div>
                <div>
                    ...
                    <div>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="bene_form">
                                ...
                                <input class="inputbutton" type="submit"  id="rzp-button1"  value="DONATE NOW" name="donate">
...
<!-- ============================= -->
        ...
        <div class="section5">
            <div>
                <img style="margin-left: -22px;" class="sec4icons" src="assets/Benefactory_Black.png" height="90"><br>
                <p class="head_desc" style="font-family: 'Inter', sans-serif">
                    We at Benefactory are on a mission to change the way the world responds to urgent crises. Our Act
        ...
        <div class="footer">
            ...
            <br>
            <div>
                <span>© Copyright Benefactory 2020</span>
            </div>
...
$conn = mysqli_connect("localhost","root","1234","payment");
...
$amount = $_POST['amount'];
    ...
    $query = "INSERT into orders (`name`, `email`, `mobile`, `amount`, `pancard`, `country`) values ('$name', '$email', '$mobile', '$amount', '$pancard', '$country')";
    $result = mysqli_query($conn, $query);
    if ($result) 
        echo "Record created";
    else
        echo "Not able to create record";
